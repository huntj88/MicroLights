...
/* Private defines -----------------------------------------------------------*/
#define fRed_Pin GPIO_PIN_14
#define fRed_GPIO_Port GPIOC
#define fGreen_Pin GPIO_PIN_15
#define fGreen_GPIO_Port GPIOC
...
#define fBlue_Pin GPIO_PIN_8
#define fBlue_GPIO_Port GPIOA
